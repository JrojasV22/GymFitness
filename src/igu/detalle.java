...
public class detalle extends javax.swing.JFrame {
    ...
    private void mostrarEjercicio(Ejercicio ejercicio) {
        ...
        categoria.setText(ejercicio.getCategoria());
        nivel.setText(ejercicio.getNivel());
        jTextArea1.setText(ejercicio.getDescripcion());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Detalles del Ejercicio");
        ...
        nombre.setText("Sentadillas");

        categoria.setForeground(new java.awt.Color(255, 255, 255));
        categoria.setText("Pierna");

        nivel.setForeground(new java.awt.Color(255, 255, 255));
        nivel.setText("Intermedio");

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("Descripción paso a paso:                                \n1. Colóquese de pie con los pies al ancho de los hombros.\n2. Baje como si fuera a sentarse, manteniendo la espalda \n recta.                                                \n3. Regrese a la posición inicial.   \n\nConsejos: Mantenga las rodillas alineadas con los pies.");
